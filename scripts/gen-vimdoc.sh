#!/usr/bin/env bash
#
# Generate doc/bemtvi-tree.txt (the vimdoc help file) from
# doc/bemtvi-tree.md using panvimdoc <https://github.com/kdheepak/panvimdoc>
...
# file is never hand-aligned. Edit doc/bemtvi-tree.md, then run this.
#
...
# --- per-plugin settings -----------------------------------------------------
PROJECT="bemtvi-tree"                             # → :help bemtvi-tree
DESCRIPTION="A dockable file explorer for bemtvi"  # header tagline (line 1)
# -----------------------------------------------------------------------------

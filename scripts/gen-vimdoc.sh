#!/usr/bin/env bash
#
# Generate doc/nxvim-tree.txt (the vimdoc help file) from
# doc/nxvim-tree.md using panvimdoc <https://github.com/kdheepak/panvimdoc>
...
# file is never hand-aligned. Edit doc/nxvim-tree.md, then run this.
#
...
# --- per-plugin settings -----------------------------------------------------
PROJECT="nxvim-tree"                             # → :help nxvim-tree
DESCRIPTION="A dockable file explorer for nxvim"  # header tagline (line 1)
# -----------------------------------------------------------------------------
